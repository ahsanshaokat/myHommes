...
urlpatterns = [
    ...
    url(r'^reset-password/$', PasswordResetView.as_view(), {'template_name':'main/reset_password.html',
    ...
    url(r'^reset-password/done/$', PasswordResetDoneView.as_view(), {'template_name': 'main/reset_password_done.html'},
    ...
    url(r'reset-password/complete/$', PasswordResetCompleteView.as_view(),{'template_name':'main/reset_password_complete.html'}, name='password_reset_complete'),
